...
CREATE PROCEDURE dbsl.GenerarFacturaInvitado
    @idInscripcion INT       -- Inscripción “modo invitado”
AS
BEGIN
    SET NOCOUNT ON;
    ...
    BEGIN
        RAISERROR('Debe indicar un idInscripcion válido.', 16, 1);
        RETURN;
    END
    ...
    BEGIN
        RAISERROR('La inscripción indicada no corresponde a un invitado de pileta.', 16, 1);
        RETURN;
    END
